...
class ControllableReLiNetSVD_unvectorized(SwitchingBaseLSTM):
    def __init__(
            self,
            control_dim: int,
            state_dim: int,
...
class ControllableReLiNetSVD_unvectorizedModel(SwitchingLSTMBaseModel):
    ...
    def __init__(self, config: ControllableReLiNetModelConfig) -> None:
        ...
        predictor = ControllableReLiNetSVD_unvectorized(
